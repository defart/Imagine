...
class GridDrawer implements GridDrawerInterface
{
    ...
    public function __construct(ChartConfig $config = null, PlotterInterface $plotter = null)
    {
        ...
        $this->scaleStepX = 5.0;
        $this->scaleStepY = 5.0;
        $this->axesStyle = new LineStyle(new RGB(new RGBPalette(), [0, 0, 0], 100), LineStyle::LINE_SOLID, 2);
        $this->gridStyle = new LineStyle(new RGB(new RGBPalette(), [50, 50, 50], 60), LineStyle::LINE_DASHED, 1, 2);
    }
