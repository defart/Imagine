...
class ChartConfigTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        return [
            'centered view no margin no padding no label' => [
                'datasets' => [
                    new DataSet([
                        [0,-1],
                        [1,-2],
                ...
                'labelAxes' => false,
                'fontSize' => 10,
                'expectedXRange' => [-10, 10],
                'expectedYRange' => [-10, 10],
                'expectedScaleFactorX' => 5.0,
                'expectedScaleFactorY' => 5.0,
                'expectedOrigin' => new Point(50,50)
            ],

            'fit view no margin no padding no label' => [
                'datasets' => [
                    new DataSet([
                        [0,-1],
                        [1,-2],
            ...
            'centered view with margin no padding no label' => [
                'datasets' => [
                    new DataSet([
                        [0,-1],
                        [1,-2],
            ...
            'centered view no margin with padding no label' => [
                'datasets' => [
                    new DataSet([
                        [0,-1],
                        [1,-2],
                ...
                'labelAxes' => false,
                'fontSize' => 10,
                'expectedXRange' => [-11.111111111111111, 11.111111111111111],
                'expectedYRange' => [-11.111111111111111, 11.111111111111111],
                'expectedScaleFactorX' => 4.5,
                'expectedScaleFactorY' => 4.5,
                'expectedOrigin' => new Point(50,50)
            ],

            'centered view no margin no padding with label' => [
                'datasets' => [
                    new DataSet([
                        [0,-1],
                        [1,-2],
