...
class LinePlotterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function providerPlot()
    {
        return [
            ...
            'dashed style' => [
                ...
                'lineStyle' => new LineStyle(new RGB(new RGBPalette(), [0, 0, 0], 100), LineStyle::LINE_DASHED, 1, 2),
                'expectedDrawerFunction' => 'line',
                'expectedCallCount' => 5
            ],
            'dotted style' => [
                'point1' => new Point(0,0),
                'point2' => new Point(0,20),
                'lineStyle' => new LineStyle(new RGB(new RGBPalette(), [0, 0, 0], 100), LineStyle::LINE_DOTTED, 1, 2),
    ...
    public function providerPlotCollection()
    {
        return [
            'default style' => [
                'collection' => new PointCollection([new Point(0,0), new Point(1,1), new Point(2,2), new Point(3,3), new Point(4,4)]),
                'lineStyle' => null,
                'expectedDrawerFunction' => 'line',
                'expectedCallCount' => 4
            ]
    ...
    {
        return [
            ['point' => new Point(0,0), 'text' => 'ABCDEFG'],
            ['point' => new Point(0,1), 'text' => 'IJKLMNO'],
            ['point' => new Point(0,2), 'text' => 'PQRSTUV'],
            ['point' => new Point(0,3), 'text' => 'WXYZ123'],
        ];
    }
}
